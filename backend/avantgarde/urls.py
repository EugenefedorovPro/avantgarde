...
from avantgarde.views import VerseView, RandVerseView, ReclamationView, ContentOrderView

urlpatterns = [
    path("content_order/<str:order>/<str:new>/", ContentOrderView.as_view(), name="content_order"),
